...
from config import DatabaseString, DatabaseString2, DatabasePassword, DjangoSecretKey, EmailAddress, EmailPassword
import socket
...
DATABASES = {
    'default': {
        ...
        'CLIENT': {
            'host': DatabaseString + DatabasePassword + DatabaseString2,
